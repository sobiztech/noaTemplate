                                    ...
                                    <div class="d-flex order-lg-2">
												...
												<div class="px-2 pb-4 pt-2">
													<div class="row mb-2">
														...
														<div class="col d-flex p-0">
															<a href="{{url('calendar2')}}" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex">
															<a href="{{url('mail-inbox')}}" class="dropdown-menu-item text-muted source-logo-container">
													...
													<div class="row mb-2">
														<div class="col d-flex">
															<a href="{{url('chat')}}" class="dropdown-menu-item text-muted source-logo-container">
														...
														<div class="col d-flex">
															<a href="{{url('products')}}" class="dropdown-menu-item text-muted source-logo-container">
                                        ...
                                        <div class="dropdown d-md-flex notifications">
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
												...
												<div class="notifications-menu ps3 overflow-hidden">
													...
													<a class="dropdown-item" href="{{url('blog-details')}}">
														<div class="notification-each d-flex">
										...
										<div class="dropdown d-md-flex profile-1">
											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
												...
												{{-- <a class="dropdown-item" href="{{url('mail-compose')}}">
												...
												{{-- <a class="dropdown-item" href="{{url('mail-inbox')}}">
